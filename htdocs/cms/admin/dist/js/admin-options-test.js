...
/* harmony export */ });
/* harmony import */ var _framework_js_components_options_OptionsPage__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @framework/js/components/options/OptionsPage */ "../vendor/bugquest/web-framework/Assets/js/components/options/OptionsPage.js");
/* harmony import */ var _framework_js_components_Translator__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @framework/js/components/Translator */ "../vendor/bugquest/web-framework/Assets/js/components/Translator.js");
/* harmony import */ var _framework_js_components_BuildHelper__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @framework/js/components/BuildHelper */ "../vendor/bugquest/web-framework/Assets/js/components/BuildHelper.js");



class TestOptionsPage extends _framework_js_components_options_OptionsPage__WEBPACK_IMPORTED_MODULE_0__.OptionsPage {
  constructor() {
    super('test');
  }
  render() {
    const wrapper = _framework_js_components_BuildHelper__WEBPACK_IMPORTED_MODULE_2__["default"].div('options-wrapper');
    const intBlock = this.createBlock('int', 'test_int_value', (0,_framework_js_components_Translator__WEBPACK_IMPORTED_MODULE_1__.__)('Valeur entière', 'admin'), null, {
      description: (0,_framework_js_components_Translator__WEBPACK_IMPORTED_MODULE_1__.__)('Un nombre entier à saisir', 'admin')
    }, 'test');
    const floatBlock = this.createBlock('float', 'test_float_value', (0,_framework_js_components_Translator__WEBPACK_IMPORTED_MODULE_1__.__)('Valeur décimale', 'admin'), null, {
      description: (0,_framework_js_components_Translator__WEBPACK_IMPORTED_MODULE_1__.__)('Un nombre à virgule pour les tests', 'admin')
    });
    const stringBlock = this.createBlock('string', 'test_string_value', (0,_framework_js_components_Translator__WEBPACK_IMPORTED_MODULE_1__.__)('Texte simple', 'admin'), null, {
      description: (0,_framework_js_components_Translator__WEBPACK_IMPORTED_MODULE_1__.__)('Une chaîne de texte modifiable', 'admin'),
      placeholder: (0,_framework_js_components_Translator__WEBPACK_IMPORTED_MODULE_1__.__)('Entrez du texte...', 'admin')
    }, 'test');
    const boolBlock = this.createBlock('bool', 'test_bool_value', (0,_framework_js_components_Translator__WEBPACK_IMPORTED_MODULE_1__.__)('Activer la fonctionnalité ?', 'admin'), null, {
      description: (0,_framework_js_components_Translator__WEBPACK_IMPORTED_MODULE_1__.__)('Active ou désactive la fonctionnalité de test', 'admin')
    }, 'test');
    const selectBlock = this.createBlock('select', 'test_select_value', (0,_framework_js_components_Translator__WEBPACK_IMPORTED_MODULE_1__.__)('Type de choix', 'admin'), null, {
      description: (0,_framework_js_components_Translator__WEBPACK_IMPORTED_MODULE_1__.__)('Choisissez une des options', 'admin'),
      options: [{
        value: 'alpha',
        label: 'Alpha'
      }, {
    ...
    const mediaBlock = this.createBlock('media', 'test_media_value', (0,_framework_js_components_Translator__WEBPACK_IMPORTED_MODULE_1__.__)('Fichier média', 'admin'), null, {
      description: (0,_framework_js_components_Translator__WEBPACK_IMPORTED_MODULE_1__.__)('Sélectionnez un média pour le test', 'admin'),
      mimeTypes: ['image/jpeg', 'image/png', 'image/webp'],
      label: (0,_framework_js_components_Translator__WEBPACK_IMPORTED_MODULE_1__.__)('Choisir un média', 'admin')
    }, 'test');

    // Ajout à l'interface
    [intBlock, floatBlock, stringBlock, boolBlock, selectBlock, mediaBlock].forEach(block => block.render(wrapper));
...
/*!*****************************************!*\
  ...
  \*****************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _admin_TestOptionsPage_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./admin/TestOptionsPage.js */ "./Assets/js/admin/TestOptionsPage.js");

document.addEventListener('DOMContentLoaded', async () => {
  await new _admin_TestOptionsPage_js__WEBPACK_IMPORTED_MODULE_0__.TestOptionsPage()?.init();
